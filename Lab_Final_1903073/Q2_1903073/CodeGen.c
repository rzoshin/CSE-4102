    ...
    for(i=0; i<code_offset; i++)
    {
        ...
        switch(code[i].op)
        {
            case START:
                    printf(".686\n");
                    printf(".model flat, c\n");
                    printf("include C:\\masm32\
                    \include\\msvcrt.inc\n");
                    printf("includelib C:\\masm32\
                    \lib\\msvcrt.lib\n");
                    printf("\n");
                    printf(".stack 200h\n");
                    printf("printf PROTO arg1:Ptr
                    Byte, printlist:VARARG\n");
                    printf("scanf PROTO arg2:Ptr Byte,
                    inputlist:VARARG\n");
                    printf("\n");
                    printf(".data\n");
                    printf("output_integer_msg_format
                    byte \"\% %d\", 0Ah, 0\n");
                    printf("output_string_msg_format
                    byte \"\% %s\", 0Ah, 0\n");
                    printf("input_integer_format byte
                    \"\% %d\",0\n");
                    printf("\n");
                    printf("number sdword ?\n");
                    printf("ok_msg byte \"Ok\", 0Ah,
                    0\n");
                    printf("not_ok_msg byte \"Not
                    Ok\", 0Ah, 0\n");
                    printf("\n");
                    printf(".code\n");
                    printf("\n");
           ...
           case PRINT_OK_VALUE:
                            ...
                            output_string_msg_format, ADDR ok_msg\n");
                            printf("\tpop ebp\n");
                            for(j=stack_variable_counter;
                            j>=1; j--)
                            printf("\tpop [ebp+%d]\n"
                            ,
                            4*j);
           ...
           case PRINT_NOT_OK_VALUE:
                            ...
                            4*code[i].arg);
                            printf("\tINVOKE printf, ADDR
                            output_string_msg_format, ADDR not_ok_msg\n");
                            printf("\tpop ebp\n");
                            for(j=stack_variable_counter;
                            j>=1; j--)
                            printf("\tpop [ebp+%d]\n"
            ...
            case GTE_OP:
                            ...
                            ,
                            code[i].arg);
                            strcat(relop_end_label,
                            number);
                            strcat(relop_start_label,
                            number);
                            printf("\tjge %s\n"
                            ,
                            relop_start_label);
